CodeBook for tidy data set file output.txt
...
tBodyAcc-std()-Y
tBodyAcc-std()-Z
    Time-domain body accelerometer means and standard deviations for 3 dimensions
...
fBodyAcc-std()-Y
fBodyAcc-std()-Z
    Frequency-domain body accelerometer means and standard deviations for 3 dimensions
